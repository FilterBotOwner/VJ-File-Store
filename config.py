...
PICS = (environ.get('PICS', 'https://te.legra.ph/file/feac659557d188afb4f7b-8ea43f998ba33e3f8a.jpg')).split() # Bot Start Picture
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '6069621485').split()]
BOT_USERNAME = environ.get("BOT_USERNAME", "FileStoreMHroBot") # without @
...
DB_URI = environ.get("DB_URI", "mongodb+srv://save:save@save.ntm3u.mongodb.net/?retryWrites=true&w=majority&appName=save")
DB_NAME = environ.get("DB_NAME", "save")
...
# Channel Information
LOG_CHANNEL = int(environ.get("LOG_CHANNEL", "-1002440970383"))
